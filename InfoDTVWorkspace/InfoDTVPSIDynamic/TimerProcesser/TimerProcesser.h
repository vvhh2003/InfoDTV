...
class TimerProcesser
{
	...
	public:
		TimerProcesser(const string aDefineFile,const string aValueFile,const unsigned int aTimerInterval,const SendBufferFunction SendBufferFnPtr,const int aRunMode=0);
		void start();
		void stop();
};
