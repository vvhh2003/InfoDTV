...
#include "../../../DataProviders/PSITime.Provider/PSITimeDataProviderFactory.h"

#include "../../../DataProviders/SPTSFileDataProvider/SPTSFileDataProviderFactory.h"
...
void MuxRuntimeConfigI::InitLoadProviderFactorys()
{
	...
	IDPF(new Multiplexer_DataProvider_V1::DynamicFileDataProviderFactory(FGCOPtr));
	RegisterProviderFactory(IDPF->getProviderTypeID(), IDPF);
	IDPF.reset(new Multiplexer_DataProvider_V1::PSITimeDataProviderFactory());
	RegisterProviderFactory(IDPF->getProviderTypeID(), IDPF);
	IDPF.reset(new Multiplexer_DataProvider_V1::SPTSFileDataProviderFactory(FGCOPtr->SPTSFilePath));
	RegisterProviderFactory(IDPF->getProviderTypeID(), IDPF);
	IDPF.reset(new Multiplexer_DataProvider_V1::SimpleTSFileDataProviderFactory());
		RegisterProviderFactory(IDPF->getProviderTypeID(), IDPF);
...
//	try
//	{
		MuxChannelStreams->ConfigChanged(aChannelName,aNewDataProviderConfig);
//	}
