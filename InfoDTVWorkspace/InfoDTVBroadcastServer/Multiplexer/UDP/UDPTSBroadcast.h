#ifndef UDPTSBROADCAST_H_
#define UDPTSBROADCAST_H_
...
namespace MultiplexerCore_V1
{
	...
	class UDPTSBroadcast : virtual public ITSBroadcastControl, virtual public Ice::Application,
...
//			TSDataPrepThread * FTSDataPrepThreadPtr;
			UDPTSBroadcastThreadPtr FUDPTSBroadcastThreadPtr;
//			UDPTSBroadcastThread* FUDPTSBroadcastThreadPtr;
			...
			virtual ~UDPTSBroadcast();
			UDPTSBroadcast(string aTargetIP,int aTargetPort,string aHostIP,int aHostPort,string aDBPath);

			UDPTSBroadcast(string aTargetIP,int aTargetPort,string aHostIP,int aHostPort,string aDBPath,string aDebugTSFile);
			UDPTSBroadcast(GlobalConfigObjectPtr aGCO);
		...
		typedef boost::shared_ptr<UDPTSBroadcast> UDPTSBroadcastPtr;
		//
